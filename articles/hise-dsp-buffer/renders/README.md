...
out\build\adt_render_composite_graphic.exe --graphic plugin-chain-routing-article-scene --gif --frames 210 --fps 15 --out articles\hise-dsp-buffer\renders\plugin-chain-routing.gif
```
